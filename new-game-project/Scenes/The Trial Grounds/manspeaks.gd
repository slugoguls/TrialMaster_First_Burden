...
@onready var audio_player = $AudioStreamPlayer2D  # Ensure an AudioStreamPlayer node exists in the scene
...
func start_interaction() -> void:
	...
	var dialogue_resource = load("res://scripts/ManSpeaks.dialogue")
